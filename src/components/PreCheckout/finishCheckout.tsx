...
import { DivTitle, DivTop, ContainerFinish, AlignIcon } from "../../pages/PrecheckinFinish/style";
        ...
        <Container gap="18px" display={true} paddingBotton="0.1px">
            <ContainerFinish>
                <DivTop>
                    <DivTitle>
                        <Title>
                            Pré Check-out Completo!
                        </Title>
                        <SmallText>
                            Parabéns! Seu cré check-out está completo. Agora, o conforto Orquestre espera por você.
                        </SmallText>
                    </DivTitle>
                </DivTop>
                <AlignIcon>
